...
public:
    ...
    /**
     * Load a single buffer from an external file path
     * @param rnboObject The RNBO CoreObject to load buffer into
     * @param bufferId The buffer ID in RNBO (e.g., "drums")
     * @param filePath Absolute path to the audio file
     * @return true if successful
     */
    static bool loadBufferFromFile(RNBO::CoreObject& rnboObject, const std::string& bufferId, const std::string& filePath);
...
private:
    ...
    /**
     * Load a single audio file from external file path
     ...
     * @return true if successful
     */
    static bool loadAudioFileFromPath(
